...
# Ajoutez ces configurations pour Channels
ASGI_APPLICATION = "project_realtime_chat.asgi.application"

# Configuration des canaux pour le développement (sans Redis)
CHANNEL_LAYERS = {
    "default": {
...
WSGI_APPLICATION = "project_realtime_chat.wsgi.application"
